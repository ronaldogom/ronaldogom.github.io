...
#define COR_DO_AVIAO 0.0,0.0,0.0,1.0
#define TEXTURA_DO_PLANO "montanhas.png"
#define TEXTURA_DO_AVIAO "pp.png"
...
void compoe_jato(void){
  ...
  glPushMatrix();
  glTranslatef(0,0,-1);
  gluCylinder(quadric, 0.7, 0.25, 1, 12, 3);
  glPopMatrix();
  ...
  gluCylinder(quadric, 0.2, 0.2, 2, 12, 3);
  quadric = gluNewQuadric();
  gluQuadricTexture(quadric, GL_TRUE);
  glTranslatef(0,0,2);
  gluCylinder(quadric, 0.2, 0.0, 1.0, 12, 3);
  glPopMatrix();
